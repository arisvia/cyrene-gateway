...
var Registry = []Tool{
	...
	},
	{
		...
		Color:       "#4D6BFE",
		Description: "DeepSeek terminal coding agent (Rust TUI / CLI)",
		ConfigType:  "custom",
		...
		Notes: []ToolNote{
			{Type: "info", Text: "DeepSeek TUI uses ~/.deepseek/config.toml. Cyrene sets the provider to 'openai' mode pointing to the gateway."},
		},
	},
	{
		ID:          "grok-cli",
